...
class MixedMonotoneModel :
    ...
    def compute_reachable_set (self, x_xh0, t_span, control_divisions=0, integral_divisions=0, method='RK45', enable_bar=True) :
        self.embed = True
        rs = Partition(x_xh0,self.func_,self.control_if,True)
