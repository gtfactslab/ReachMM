...
rs, runtime = run_time(model.compute_reachable_set, x0d, t_span, 0, 1, 'euler', t_step, enable_bar=False)
print(runtime)
print(rs([0,1.25]))
# rs, runtime = run_time(model.compute_reachable_set, x0d, t_span, 1, 0, 'euler', t_step, enable_bar=False)
# print(runtime)
# print(rs(1.25))
# rs, runtime = run_time(model.compute_reachable_set, x0d, t_span, 0, 1, 'euler', t_step, enable_bar=False)
# print(runtime)
# print(rs(1.25))
# rs, runtime = run_time(model.compute_reachable_set, x0d, t_span, 1, 1, 'euler', t_step, enable_bar=False)
# print(runtime)
# print(rs(1.25))
